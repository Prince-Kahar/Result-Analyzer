    ...
    <div className="max-w-3xl mx-auto space-y-6 py-4">
      <div className="text-center space-y-1">
        ...
        <p className="text-xs sm:text-sm text-slate-400">
          Upload multi-page university result gazette to extract students, internal/external marks, and SGPA.
        </p>
      </div>
      ...
      <div className="glass-panel p-6 sm:p-8 space-y-6">
        <form onSubmit={handleUpload} className="space-y-6">
          ...
          <div className="border-2 border-dashed border-slate-700/80 hover:border-teal-500/60 rounded-2xl p-8 text-center transition-colors bg-slate-900/30">
            ...
            <label htmlFor="file-upload" className="cursor-pointer flex flex-col items-center gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-400">Supported format: .pdf (Max size 50MB)</p>
              </div>
            </label>
          </div>
          ...
          >
            {uploading ? 'Processing Marksheet...' : 'Parse & Ingest to Supabase'}
          </button>
        </form>
